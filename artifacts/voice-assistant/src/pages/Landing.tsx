...
export default function Landing({ onStart }: LandingProps) {
  ...
  // Ensure autoplay works on Safari
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Very subtle darkening overlay for readability */}
        <div
          aria-hidden="true"
          style={{
            position: "absolute",
            inset: 0,
            background:
              "linear-gradient(to bottom, rgba(0,0,0,0.18) 0%, rgba(0,0,0,0) 30%, rgba(0,0,0,0) 70%, rgba(0,0,0,0.30) 100%)",
            pointerEvents: "none",
          }}
        />
